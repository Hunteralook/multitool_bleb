(() => {
  ...
  const ACTION_LABELS = Object.freeze({
    ...
    "killfeed.toggle": "Переключение клиентского киллфида",
    "killfeed.color": "Изменение цветов клиентского киллфида",
    "killfeed.clear": "Очистка клиентского киллфида",
    "killfeed.reset": "Сброс клиентского киллфида",
