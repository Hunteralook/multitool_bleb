(() => {
  ...
  const ACTION_LABELS = Object.freeze({
    ...
    "skybox.apply": "Локальная смена скайбокса",
    "skybox.restore": "Возврат неба карты",
    "skybox.reset": "Сброс скайбокса",
    "lighting.toggle": "Переключение освещения мира",
    "lighting.color": "Цвет мира",
    "lighting.night": "Ночной режим",
    "lighting.fog": "Локальный туман",
    "lighting.reset": "Сброс освещения",
    "weather.toggle": "Переключение локальной погоды",
    "weather.type": "Тип локальной погоды",
    "weather.option": "Настройка локальной погоды",
    "weather.reset": "Сброс локальной погоды",
    "world.reset": "Сброс настроек мира",
    "trail.toggle": "Переключение следа игрока",
    "trail.clear": "Очистка следа игрока",
    "trail.style": "Стиль следа игрока",
    "trail.option": "Настройка следа игрока",
    "trail.reset": "Сброс следа игрока",
